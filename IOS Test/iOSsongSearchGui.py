...
from spotifyTest2 import test_song
...
class SimpleGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap(r"songLogo1.png")  # Use raw string for the path
        ...
        self.text_field.setPlaceholderText("Search any Song Name")
        ...
        # Create call button
        self.call_button = QPushButton("Search", self)
