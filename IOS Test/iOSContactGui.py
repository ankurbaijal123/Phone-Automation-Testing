...
from iOSCallTest import test_call
class SimpleGUI(QMainWindow):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap(r"contact1.png")  # Use raw string for the path
        ...
        self.text_field.setPlaceholderText("Call by Name")
        ...
        self.call_button.setFixedSize(100, 50)
